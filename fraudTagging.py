...
plt.savefig(OUTPUT_FOLDER + '/conversionRate_per5secs.png')
plt.clf()
...
plt.savefig(OUTPUT_FOLDER + '/threshold_per5secs_clickSquared.png')
plt.clf()
...
new_data.to_csv(OUTPUT_FOLDER + '/TaggedData_per5secs.csv')
...
##new_data.to_csv(OUTPUT_FOLDER + '/TaggedData_per15secs.csv')
